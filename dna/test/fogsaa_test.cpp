...
TEST_CASE("fogsaa: Given two stands with single same base, no mutations should exist")
{
...
TEST_CASE("fogsaa: Given two not similar stands (center mutation), 1 mutation should exist")
{
...
TEST_CASE("fogsaa: Given two not similar stands (alt mutations), 2 mutations should exist")
{
...
//TEST_CASE("fogsaa: Given two similar stands where one is offset, 1 mutation should exist")
//{
    //fake_stream s1("ATTC", 512);
    //fake_stream s2("ATAC", 512);
    //fogsaa aligner;
